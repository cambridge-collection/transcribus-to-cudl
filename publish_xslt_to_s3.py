...
s3keyDir = "projects/curious-cures/xslt/"
...
def main():
    ...
    # zip up xslt
    # zip -r curious-cures-xslt-<version_number>.zip xslt
    shutil.make_archive("curious-cures-xslt-"+version, 'zip', ".", "xslt")
    zip_file = "curious-cures-xslt-"+version+".zip"
...
# upload to s3
# aws s3 cp cudl-transform-xslt.zip s3://cudl-artefacts/projects/curious-cures/xslt/curious-cures-xslt-<version_number>.zip
